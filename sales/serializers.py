...
class OutcomeSerializer(serializers.ModelSerializer):
    product_list = OutcomeItemSerializer(many=True, write_only=True)
    ...
    def update(self, instance, validated_data):
        ...
        user = self.context['request'].user
        dealer_group = user.dealer_groups.first()
        client = validated_data.pop('client', instance.client)
        ...
        if items_data is not None:
            ...
            instance.debt = validated_data.get('debt', total_sold)
        ...
        instance.user = user
        instance.dealer_group = dealer_group
        instance.save()
